...
export default function EditText() {
  ...
  useEffect(() => {
    const s = io("https://text-editor-qsha.onrender.com/")
  ...
  return (
    <div className="edit-text-container">
      <div className="toolbar-wrapper">
        ...
        <div className={`custom-toolbar ${windowWidth <= 1000 ? 'mobile' : ''}`}>
          <div className="save-dropdown" ref={saveDropdownRef}>
            <button className="save" onClick={() => setIsSaveDropdownOpen(!isSaveDropdownOpen)}>
              {windowWidth <= 1000 ? 'Save' : 'Save'}
            </button>
            {isSaveDropdownOpen && (
          ...
          <button className="share" onClick={shareDocument}>
            {windowWidth <= 1000 ? 'Share' : 'Share'}
          </button>
        </div>
      </div>
